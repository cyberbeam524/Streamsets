...
def log_processing():
    ...
    create_es_sink_ddl = """
            CREATE TABLE es_sink(
                ...
                payAmount DOUBLE,
                payPlatform INT,
                locationpoint STRUCT<Lat DOUBLE, Lon DOUBLE>,
            ) with (
    ...
    t_env.from_path("payment_msg") \
        .select("province_id_to_name(provinceId) as province, createTime, orderId, payAmount, payPlatform, CAST(ST_WKTToSQL(location) AS STRING) locationpoint") \
